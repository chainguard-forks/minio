...
func _() {
	...
	_ = x[ErrSTSLDAPAuthFailure-15]
	_ = x[ErrSTSTooManyAuthRequests-16]
}

const _STSErrorCode_name = ""

var _STSErrorCode_index = [...]uint16{0, 7, 22, 41, 65, 91, 118, 145, 171, 192, 219, 244, 261, 281, 297, 313, 331, 353}
